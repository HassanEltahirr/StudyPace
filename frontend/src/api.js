...
export const api = {
  ...
  getLessonAiSummary: (lectureId) => req('GET', `/learning/lectures/${lectureId}/ai-summary`),
  generatePracticeExam: (lectureId, data) => req('POST', `/learning/lectures/${lectureId}/practice-exam`, data, { timeoutMs: 90000, invalidate: false }),
  getLessonVideos: (lectureId) => req('GET', `/learning/lectures/${lectureId}/videos`, null, { cacheMs: 300000 }),
